...
const AppSettings = () => {
    ...
    const settingsConfig = [
        ...
        { key: 'signup_bonus_cash', label: 'Signup Bonus (Cash ₹)', type: 'number', icon: '🎁' },
        { key: 'signup_bonus_coins', label: 'Signup Bonus (Coins)', type: 'number', icon: '🪙' },
        { key: 'referral_fixed_reward', label: 'Referral Fixed Reward (₹)', type: 'number', icon: '💰' },
        { key: 'referral_commission_percent', label: 'Referral Commission (%)', type: 'number', icon: '📊' },
        { key: 'referral_reward_type', label: 'Referral Reward Type (fixed/percent/both)', type: 'text', icon: '⚙️' },
        ...
        { key: 'checkin_target_days', label: 'Check-in Target Days', type: 'number', icon: '🎯' },
        { key: 'checkin_target_reward', label: 'Check-in Target Reward', type: 'number', icon: '🏆' },
    ];
