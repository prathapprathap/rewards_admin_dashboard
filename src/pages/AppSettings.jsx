...
const AppSettings = () => {
    const [settings, setSettings] = useState({
        ...
        signup_bonus_cash: '5',
        min_withdrawal: '100',
        withdrawal_daily_limit: '2',
        withdraw_method_upi: 'On',
        withdraw_method_bank: 'On',
    ...
    const settingsConfig = [
        ...
        { key: 'withdrawal_daily_limit', label: 'Max Withdrawals Per Day (per user)', type: 'number', icon: '🔢' },
        { key: 'withdraw_method_upi', label: 'Enable UPI Withdrawal', type: 'toggle', icon: '📱' },
        { key: 'withdraw_method_bank', label: 'Enable Bank Transfer Withdrawal', type: 'toggle', icon: '🏦' },
        ...
        { key: 'rate_us_url', label: 'Rate Us Link (Play Store / App Store)', type: 'text', icon: '⭐' },
